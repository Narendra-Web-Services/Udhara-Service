...
def _register_routes(parent_router: APIRouter, *, include_in_schema: bool) -> None:
	...
	parent_router.include_router(forgot_password_router, prefix="/auth", include_in_schema=include_in_schema)
	...
	parent_router.include_router(subscription_router, prefix="/auth", include_in_schema=include_in_schema)
